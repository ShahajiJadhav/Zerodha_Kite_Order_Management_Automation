...
"""
Local (verbose) HFT bot for Kite — COMPLETE version (force-update SL every cycle with diagnostics)
...
- **Diagnostics**: Per-symbol line each cycle: prev_candle_ts, computed_trig, ltp, action

Dependencies:
  pip install kiteconnect selenium webdriver-manager beautifulsoup4 pandas pytz requests python-dotenv
...
def gather_signals():
    ...
    buy_payload  = {"scan_clause": '''( {1339018} ( ( {cash} ( ( {cash} ( latest close > 25 and latest close < 80 and( {cash} ( [0] 10 minute volume > 50000 or( {cash} ( [0] 5 minute volume > 30000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 80 and latest close < 150 and( {cash} ( [0] 10 minute volume > 45000 or( {cash} ( [0] 5 minute volume > 25000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 150 and latest close < 500 and( {cash} ( [0] 10 minute volume > 35000 and( {cash} ( [0] 5 minute volume > 14000 and [-1] 5 minute volume > 14000 ) ) ) ) ) ) or( {cash} ( latest close > 500 and latest close < 3000 and( {cash} ( [0] 10 minute volume > 30000 or( {cash} ( [-1] 5 minute volume > 10000 and [0] 5 minute volume > 25000 ) ) ) ) ) ) ) ) and [-1] 5 minute count( 20, 1 where [-1] 5 minute close > [-1] 5 minute supertrend( 18 , 1.1 ) ) > 12 and [0] 1 hour volume >= 200000 and [0] 5 minute volume > [0] 5 minute sma( [0] 5 minute volume , 9 ) and [0] 5 minute close > 1 day ago close * 1.01 and abs( [0] 5 minute close - [0] 5 minute open ) > [0] 5 minute open * 0.0025 and( {cash} ( ( {cash} ( latest volume < 1000000 and [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} < 75 ) ) or latest volume > 1000000 ) ) and( {cash} ( [0] 5 minute close > [0] 5 minute supertrend( 18 , 1.1 ) and [0] 5 minute close > [0] 5 minute open and [0] 5 minute close > [-1] 5 minute min( 12 , [-1] 5 minute close ) * 1.01 and [0] 5 minute close > ( [=-1] 5 minute high + [=-1] 5 minute low ) / 2 and abs( [0] 5 minute close - [0] 5 minute open ) > abs( [-1] 5 minute open - [-1] 5 minute close ) and [0] 5 minute close > [-1] 5 minute max( 12 , [-1] 5 minute high ) ) ) and( {cash} ( [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} > 65 or [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} < 35 ) ) ) )'''}
    sell_payload = {"scan_clause": '''( {1339018} ( ( {cash} ( ( {cash} ( latest close > 25 and latest close < 80 and( {cash} ( [0] 10 minute volume > 50000 or( {cash} ( [0] 5 minute volume > 30000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 80 and latest close < 150 and( {cash} ( [0] 10 minute volume > 45000 or( {cash} ( [0] 5 minute volume > 25000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 150 and latest close < 500 and( {cash} ( [0] 10 minute volume > 35000 and( {cash} ( [0] 5 minute volume > 14000 and [-1] 5 minute volume > 14000 ) ) ) ) ) ) or( {cash} ( latest close > 500 and latest close < 3000 and( {cash} ( [0] 10 minute volume > 30000 or( {cash} ( [-1] 5 minute volume > 10000 and [0] 5 minute volume > 25000 ) ) ) ) ) ) ) ) and [-1] 5 minute count( 20, 1 where [-1] 5 minute close < [-1] 5 minute supertrend( 18 , 1.1 ) ) > 12 and [0] 5 minute volume > [0] 5 minute sma( [0] 5 minute volume , 9 ) and [0] 1 hour volume >= 200000 and [0] 5 minute close < 1 day ago close * 0.99 and abs( [0] 5 minute close - [0] 5 minute open ) > [0] 5 minute open * 0.0025 and( {cash} ( ( {cash} ( latest volume < 1000000 and [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} > 25 ) ) or latest volume > 1000000 ) ) and( {cash} ( [0] 5 minute close < [0] 5 minute supertrend( 18 , 1.1 ) and [0] 5 minute close < [0] 5 minute open and [0] 5 minute close < [-1] 5 minute max( 12 , [-1] 5 minute close ) * 0.99 and abs( [0] 5 minute close - [0] 5 minute open ) > abs( [-1] 5 minute open - [-1] 5 minute close ) and [0] 5 minute close < [-1] 5 minute min( 12 , [-1] 5 minute low ) and [0] 5 minute close < ( [=-1] 5 minute high + [=-1] 5 minute low ) / 2 ) ) and( {cash} ( [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} > 65 or [0] 5 minute {custom_indicator_165412_start}\"sma(  stochrsi( 18 ) , 3 )\"{custom_indicator_165412_end} < 35 ) ) ) )'''}
...
def place_market_entry(symbol, side):
    ...
    with entry_lock:
        ...
        if side.upper() == "SELL" and ltp_before > trig:
            ...
            return None
        if gap_pct > pct:
            log(f"[entry] {sym} gap {gap_pct:.2f}% > {pct} — skipped.")
            return None
