...
def gather_signals():
    ...
    buy_payload  = {
        "scan_clause": '( {1339018} ( ( {cash} ( ( {cash} ( latest close > 25 and latest close < 80 and( {cash} ( [0] 10 minute volume > 50000 or( {cash} ( [0] 5 minute volume > 30000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 80 and latest close < 150 and( {cash} ( [0] 10 minute volume > 45000 or( {cash} ( [0] 5 minute volume > 25000 and [-1] 5 minute volume > 20000 ) ) ) ) ) ) or( {cash} ( latest close > 150 and latest close < 500 and( {cash} ( [0] 10 minute volume > 35000 and( {cash} ( [0] 5 minute volume > 14000 and [-1] 5 minute volume > 14000 ) ) ) ) ) ) or( {cash} ( latest close > 500 and( {cash} ( [0] 10 minute volume > 30000 or( {cash} ( [-1] 5 minute volume > 10000 and [0] 5 minute volume > 25000 ) ) ) ) ) ) ) ) and [-1] 5 minute count( 20, 1 where [-1] 5 minute close > [-1] 5 minute supertrend( 18 , 1.1 ) ) > 14 and [0] 5 minute volume > [0] 5 minute sma( [0] 5 minute volume , 9 ) and [0] 5 minute close > [-1] 5 minute max( 9 , [-1] 5 minute close ) * 0.9965 and [0] 1 hour volume >= 200000 and [0] 5 minute close > 1 day ago close * 1.004 and [-3] 5 minute count( 10, 1 where abs( [-3] 5 minute close - [-3] 5 minute open ) < [-3] 5 minute close * 0.004 ) > 5 and abs( [0] 5 minute close - [0] 5 minute open ) > [0] 5 minute open * 0.0025 and [0] 5 minute close > [0] 5 minute open and( {cash} ( ( {cash} ( latest volume < 1000000 and [0] 5 minute {custom_indicator_165412_start}"sma(  stochrsi( 18 ) , 3 )"{custom_indicator_165412_end} < 75 ) ) or latest volume > 1000000 ) ) and [0] 5 minute {custom_indicator_165411_start}"sma(  sma(  stochrsi( 18 ) , 3 ) , 3 )"{custom_indicator_165411_end} < [0] 5 minute {custom_indicator_165412_start}"sma(  stochrsi( 18 ) , 3 )"{custom_indicator_165412_end} ) )'
    }
    sell_payload = {
